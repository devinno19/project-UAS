...
footer p {
	...
	<section id="Sejarah">
		<h2>KURIKULUM</h2>
		<p>Kurikulum Sistem Paket pada Program Studi D-III Perpajakan yang berlaku saat ini mengacu pada kurikulum 2021.</p>
        <li><img src="kurikulum/img/kurikulum.png"></li>
	</section>
	<footer>
...
---
title: KURIKULUM
media_order: 'Kurikulum-768x556 (1).png'
---
